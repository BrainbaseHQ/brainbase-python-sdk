...
def _get_open_connections(client: Brainbase | AsyncBrainbase) -> int:
...
class TestBrainbase:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "brainbase/_legacy_response.py",
                        "brainbase/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "brainbase/_compat.py",
    ...
    def test_hardcoded_query_params_in_url(self, client: Brainbase) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: Brainbase) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: Brainbase) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    def test_base_url_trailing_slash(self, client: Brainbase) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Brainbase) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Brainbase) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/api/workers").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: Brainbase, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.workers.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.workers.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncBrainbase:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncBrainbase) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncBrainbase) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_retries_taken(
        ...
        response = await client.workers.with_raw_response.list()
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.workers.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.workers.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
